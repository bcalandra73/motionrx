...
export function LoadingState({ stage, label }: Props) {
  ...
  return (
    <div id="loadingState" style={{ display: 'block', padding: '60px 24px', textAlign: 'center' }}>
      ...
      <div className="loading-sub">MediaPipe detects poses on every frame, motion analysis selects key phase frames, then Claude AI generates your clinical report</div>
