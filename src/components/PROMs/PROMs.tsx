...
const HR = () => <hr style={{ margin: '16px 0', border: 'none', borderTop: '1px solid var(--border)' }} />;
...
export function PROMs(props: Props) {
  ...
  return (
    <Card icon="📋" title="Patient Reported Outcomes (PROMs)" subtitle={subtitle} optional>
      {/* Region selector */}
      <div>
        ...
        <div className="prom-region-tabs" style={{ marginTop: 8 }}>
      ...
      <div>
        ...
        <div className="prom-scale" id="nprsScale" style={{ marginTop: 8 }}>
      ...
      <div>
        ...
        <div id="psfsItems" style={{ marginTop: 8 }}>
          {[
      ...
      {region === 'lower' && (
        <>
          ...
          <div>
            ...
            <div className="lefs-grid" style={{ marginTop: 8 }}>
      ...
      {region === 'spine' && (
        <>
          ...
          <div>
            ...
            <div id="odiGrid" style={{ marginTop: 8 }}>
